...
export default function About() {
  return (
    <div>
        ...
        <h4>Education</h4>
        <p>I graduated Hyperion Univeristy with a major in Psychology. After that, I got a certificate in programming, specifically front-end.</p>
        <p>Programming was also what I studied in highschool.</p>
